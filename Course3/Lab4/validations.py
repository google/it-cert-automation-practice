...
def validate_user(username, minlen):
    ...
    if type(username) != str:    raise TypeError("username must be a string")
...
print(validate_user(".blue.kale", 3)) # False, as it should be
print(validate_user("red_quinoa", 4)) # True
print(validate_user("_red_quinoa", 4)) # False, as it should be
